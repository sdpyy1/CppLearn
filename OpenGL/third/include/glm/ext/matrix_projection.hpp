...
///
/// Include <glm/ext/matrix_projection.hpp> to bind the features of this extension.
///
...
namespace glm
{
	...
	/// To change default near and far clip planes definition bind GLM_FORCE_DEPTH_ZERO_TO_ONE.
	///
	/// @param obj Specify the object coordinates.
	/// @param model Specifies the current modelview matrix
	/// @param proj Specifies the current projection matrix
